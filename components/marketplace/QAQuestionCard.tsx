    ...
    <div className="bg-white/5 border border-white/[0.08] rounded-lg p-4">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <p className="text-sm text-white/80 line-clamp-3">{question.questionText}</p>

          {question.aiContext?.projectSummary && (
            <div className="mt-2 bg-white/5 rounded px-2 py-1.5">
            ...
            {isBidding ? (
              <>
                <div className="text-right">
                  <span className="text-xs font-medium text-rust">Specialist</span>
                  {bidTimeLeft > 0 && (
                  ...
                  {bidTimeLeft === 0 && question.bidDeadline && (
                    <p className="text-[10px] text-red-400">Deadline passed</p>
                  )}
                </div>
              ...
              <>
                {!isFree && expertEarnings && (
                  <div className="text-right">
                    ...
                    <p className="text-[10px] text-white/40">You earn · Est. {estMinutes}</p>
                  </div>
                )}
                {isFree && (
                  <span className="text-xs font-medium text-white/40">Free question</span>
                )}
