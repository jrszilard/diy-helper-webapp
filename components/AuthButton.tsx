          ...
          <div className="bg-[#FDFBF7] rounded-2xl max-w-md w-full shadow-2xl border border-[#D4C8B8] overflow-hidden">
            ...
            <div className="px-6 pb-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 border-2 border-[#D4C8B8] rounded-lg px-4 py-3 hover:bg-[#F5F0E6] font-semibold transition disabled:opacity-50 text-[#3E2723]"
              >
              ...
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-[#FDFBF7] text-[#7D6B5D]">or</span>
                </div>
              </div>
